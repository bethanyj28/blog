---
title: 'A GopherCon Retrospective'
...
First things first, here is the talk recording: [Not Your Parent's Editor: A Gopher's Guide to Neovim](https://www.youtube.com/watch?v=3FnwJ_axbOw)
...
## What's changed?
Since giving the talk, the Copilot CLI was finally released and I have been integrating it using [sidekick.nvim](https://github.com/folke/sidekick.nvim) which is made by the legendary folke.

One thing I didn't get to mention is my use of [Chezmoi](https://www.chezmoi.io/) to manage my dotfiles. It is so nice if you leverage multiple machines and virtual development environments such as GitHub Codespaces. It makes it super easy to keep everything in sync and revert if anything goes astray.
