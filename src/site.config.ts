...
const config: SiteConfig = {
  ...
  description:
    'Yapping into the void on code, art, food, and anything else that comes to mind.',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'Bethany Janos',
  // Keywords for SEO, used in the meta tags.
  tags: ['Golang', 'Terminal', 'Coding', 'trustyduck', 'bethanyj28'],
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/bethanyj28/blog',
      external: true,
    },
  ],
  ...
  socialLinks: {
    ...
    email: 'mailto:hi@bethanyjanos.com',
    linkedin: 'https://www.linkedin.com/in/bethanyjanos/',
  ...
  giscus: {
    repo: 'bethanyj28/blog',
    repoId: 'R_kgDOQxT_1Q',
    category: 'General',
    categoryId: 'DIC_kwDOQxT_1c4C0Z3F',
